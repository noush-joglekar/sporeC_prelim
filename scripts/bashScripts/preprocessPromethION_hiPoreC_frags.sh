...
for i in $(ls $inputDir/*reads_alignment.csv.gz) ; do \
batch=$(echo $i | awk '{split($1,b,"_"); print b[5]}') ; \
echo "Processing batch "$batch; \
sh /gpfs/commons/groups/gursoy_lab/ajoglekar/Projects/2023_03_01_multiwayInteractions/v0.analysis/scripts/bashScripts/getGeneNamesFromChromunities_hiPoreC.bash $i \
