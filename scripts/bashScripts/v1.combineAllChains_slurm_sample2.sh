...
echo "Starting at:" `date` >> combineAllChains_dict_sample2.log

echo "This is job number:" $SLURM_JOB_ID >> combineAllChains_dict_sample2.log
echo "Running on node:" `hostname` >> combineAllChains_dict_sample2.log
echo "Running on cluster:" $SLURM_CLUSTER_NAME >> combineAllChains_dict_sample2.log
echo "This job was assigned the temporary (local) directory:" $TMPDIR >> combineAllChains_dict_sample2.log
