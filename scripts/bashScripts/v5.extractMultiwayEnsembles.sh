...
$SLURM_ARRAY_TASK_ID inputData/cell_1_10000_chains_reconstructed/ cell1_output/ --prim_cutoff 110 --sec_cutoff 300 \
--num_processes 4 --offDiagDist 1 --cellType A

echo "Cell type 2"
time python /gpfs/commons/groups/gursoy_lab/ajoglekar/Projects/2023_03_01_multiwayInteractions/v0.analysis/scripts/pythonScripts/extractEnsembles_multiwayConstrained.py \
$SLURM_ARRAY_TASK_ID inputData/cell_2_10000_chains_reconstructed/ cell2_output/ --prim_cutoff 110 --sec_cutoff 300 \
