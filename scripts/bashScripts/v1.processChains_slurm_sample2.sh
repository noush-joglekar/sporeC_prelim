...
#SBATCH --job-name=10k_s2
#SBATCH --time=03:00:00   # HH/MM/SS
#SBATCH --mem=6G   # memory requested, units available: K,M,G,T
#SBATCH --mail-user=ajoglekar@nygenome.org
#SBATCH --mail-type=FAIL

echo "Starting at:" `date` >> 10k_sample2_550_750_3.log

echo "This is job number:" $SLURM_JOB_ID >> 10k_sample2_550_750_3.log
echo "Running on node:" `hostname` >> 10k_sample2_550_750_3.log
echo "Running on cluster:" $SLURM_CLUSTER_NAME >> 10k_sample2_550_750_3.log
echo "This job was assigned the temporary (local) directory:" $TMPDIR >> 10k_sample2_550_750_3.log
...
chains_500_10000_1500_1696950861/ v2.processChainsOutput_10k_500_sample2/ SLURM_ARRAY_TASK_ID 550 750 4 --offDiagLim 3
