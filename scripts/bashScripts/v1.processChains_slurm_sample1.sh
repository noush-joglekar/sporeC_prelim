...
echo "Starting at:" `date` >> 10k_sample1_500_750_3.log

echo "This is job number:" $SLURM_JOB_ID >> 10k_sample1_500_750_3.log
echo "Running on node:" `hostname` >> 10k_sample1_500_750_3.log
echo "Running on cluster:" $SLURM_CLUSTER_NAME >> 10k_sample1_500_750_3.log
echo "This job was assigned the temporary (local) directory:" $TMPDIR >> 10k_sample1_500_750_3.log
...
chains_500_10000_1500_1681171613/ v2.processChainsOutput_10k_500_sample1/ $SLURM_ARRAY_TASK_ID 500 750 4 --offDiagLim 1
