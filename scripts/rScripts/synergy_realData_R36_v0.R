...
testFile <- testFile %>% tidyr::separate(Read,c("R","read_idx","C","card"),sep = ":|_") %>% dplyr::select(-c(R,C))
...
test_chr18_sliding_chrom = sliding_window_chromunity(concatemers = testFile, chr = "chr18",
